...
/**
 * Adds Recent Badges widget.
 */
class RecentBadges extends WP_Widget {
    ...
    public function __construct() {
        parent::__construct(
                'RecentBadgesWidget', // Base ID
                'RecentBadgesWidget', // Name
...
add_action('widgets_init', create_function('', 'register_widget("RecentBadges");'));
?>
