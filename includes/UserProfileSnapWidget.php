...
class UserProfileSnapWidget extends WP_Widget {
    ...
    public function __construct() {
        parent::__construct(
                'UserProfileSnapWidget', // Base ID
                'UserProfileSnapWidget', // Name
...
add_action('widgets_init', create_function('', 'register_widget( "UserProfileSnapWidget" );'));
