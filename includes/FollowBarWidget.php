...
/**
 * Adds Follow Bar widget.
 */
class FollowBar extends WP_Widget {
    ...
    public function __construct() {
        parent::__construct(
                'FollowBarWidget', // Base ID
                'FollowBarWidget', // Name
...
add_action('widgets_init', create_function('', 'register_widget("FollowBar");'));
?>
